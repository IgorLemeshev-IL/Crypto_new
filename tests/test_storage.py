...
class TestSqliteStorage:
    ...
    def test_save_twice_creates_two_snapshots(self, storage, sample_asset):
        ...
        storage.save({
            "top_gainers": [
                {"name": sample_asset.name, "symbol": sample_asset.symbol, "price": 100.0, "change_24h": 1.0}
            ]
        })
        storage.save({
            "top_gainers": [
                {"name": sample_asset.name, "symbol": sample_asset.symbol, "price": 200.0, "change_24h": 2.0}
            ]
        })
